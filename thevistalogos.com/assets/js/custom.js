...
// $('.pop_main_content a').click(function(){
//   $('#main_popup').hide();
// });
setTimeout(function() {
    $('#main_popup').modal('show');
  }, 10000); 
  

function thmCounter() {
    
    $('.counter li').counterUp({
        delay: 10,
        time: 3000
...
if ($(window).width() < 768) {
    ...
    if($('#pricing-carousel-sm').length != 0){
        $('#pricing-carousel-sm').addClass('owl-carousel owl-theme');
        $('#pricing-carousel-sm').owlCarousel({
            loop: true,
            margin: 0,
            nav: false,
            items:2,
    ...
    if($('#portfolio-slider-sm').length != 0){
        $('#portfolio-slider-sm').addClass('owl-carousel owl-theme');
        $('#portfolio-slider-sm').owlCarousel({
            loop: true,
            margin: 0,
            nav: false,
            items:2,
